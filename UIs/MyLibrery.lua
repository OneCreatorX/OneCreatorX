...
loadingLabel.BackgroundTransparency = 0.90
...
local loadingTween = createTween(loadingBar, UDim2.new(1, 0, 0.5, 0), 5)
loadingTween:Play()
loadingTween.Completed:Connect(function()
    loadingLabel.Text = "OneLib 0.1"
    wait(2)
    screenGui:Destroy()
...
local rainbowColors = {Color3.fromRGB(255, 0, 0), Color3.fromRGB(255, 127, 0), Color3.fromRGB(255, 255, 0), Color3.fromRGB(0, 255, 0), Color3.fromRGB(0, 0, 255), Color3.fromRGB(0, 0, 128), Color3.fromRGB(75, 0, 130), Color3.fromRGB(148, 0, 211)}
local colorIndex = 1

while loadingTween.PlaybackState ~= Enum.PlaybackState.Completed do
    wait(0.3)
    loadingBar.BackgroundColor3 = rainbowColors[colorIndex]

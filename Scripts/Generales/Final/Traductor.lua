...
game:GetService("StarterGui"):SetCore("SendNotification",
    {
        ...
        Text = "API de Google Translate",
        Duration = 3
    }
)
                  
properties.Text = "[TR] Para enviar mensajes en un idioma, di > seguido del idioma objetivo/código de idioma, por ejemplo: >ru o >ruso. Para desactivar (volver al idioma original), di >d."
...
function disableSend()
    sendEnabled = false
    properties.Text = "[TR] Envíos Desactivados"
    StarterGui:SetCore("ChatMakeSystemMessage", properties)
end

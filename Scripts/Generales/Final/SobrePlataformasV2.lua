...
local colorIndex = 1
local previousPlatformHeight = 0
...
local function generatePlatform(position)
    ...
    local newY = previousPlatformHeight + (newPlatform.Size.Y / 2)

    newPlatform.Position = Vector3.new(position.X, newY, position.Z)

    newPlatform.Parent = workspace

    previousPlatformHeight = newY

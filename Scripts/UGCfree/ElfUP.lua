local w=game:GetService("Workspace")local p=game:GetService("Players")local sg=Instance.new("ScreenGui")sg.Name="AutoScript"sg.Parent=p.LocalPlayer.PlayerGui local t1=Instance.new("TextLabel",sg)t1.Name="OneCreatorX"t1.Text="OneCreatorX"t1.BackgroundTransparency=1 t1.Position=UDim2.new(0.5,-50,0.5,-12.5)t1.Size=UDim2.new(0,100,0,25) t1.TextSize = 25 local t2=Instance.new("TextLabel",sg)t2.Name="ElfUPv1"t2.Text="Elf UP v1"t2.BackgroundTransparency=1 t2.Position=UDim2.new(0.5,-50,0.5,12.5)t2.Size=UDim2.new(0,100,0,25) t2.TextSize = 25

...
Title.Text, Title.Size, Title.Position, Title.BackgroundColor3, Title.Parent = "Walking UGC", UDim2.new(0, 120, 0, 20), UDim2.new(0, 0, 0, 0), Color3.new(0.8, 0.8, 0.8), Frame
